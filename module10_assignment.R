...
setwd("/Users/kirillvinogradov/Documents/US Berkeley/Data Science/week10/")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputId = "subset_income", label = "Include Income:",
                  choices = c( HigherOrEqual50 = "<=50k", LessThan50 = ">50k")),
                 
      # Interactive piece 2: inputId = "set_yaxis"
      selectInput(inputId = "subset_yaxis", label = "Include Yaxis:",
...
server <- function(input, output) {
  ...
  output$myfigure <- renderPlot(ggplot(create_subset()) +
                                  ...
                                  geom_point(aes_string(x = "occupation", y = input$set_yaxis)) +
                                  theme_bw(18) +
